...
<head>
  ...
  <title>Joseph Wilcock — Maths Tutor (A‑Level & GCSE)</title>
  <meta name="description" content="Online A‑Level & GCSE maths tutoring by Joseph Wilcock — Warwick University undergraduate. Clear exam-focused lessons, personalised plans, £20/hr." />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600;700;800&display=swap" rel="stylesheet">
  <style>
    :root{
      --bg:#0f1724; --card:#0b1220; --accent:#6ee7b7; --muted:#9aa7b2; --glass: rgba(255,255,255,0.04);
      --maxw:1100px;
      color-scheme: dark;
    }
    *{box-sizing:border-box}
    ...
    body{
      margin:0; font-family:Inter,system-ui,Segoe UI,Roboto,Arial; background:linear-gradient(180deg,#071022 0%, #071724 55%, #06131a 100%); color:#e6eef3; -webkit-font-smoothing:antialiased; -moz-osx-font-smoothing:grayscale;
    ...
    .logo{width:64px; height:64px; border-radius:12px; background:linear-gradient(135deg,#092a48,#0b5b6b); display:flex; align-items:center; justify-content:center; font-weight:800; color:white; font-size:20px; box-shadow:0 6px 20px rgba(0,0,0,0.6)}
    h1{font-size:28px; margin:0}
    .tag{color:var(--muted); font-size:14px}

    .hero{display:grid; grid-template-columns:1fr 380px; gap:28px; align-items:start}
    .card{background:linear-gradient(180deg, rgba(255,255,255,0.02), rgba(255,255,255,0.015)); border-radius:14px; padding:22px; box-shadow: 0 8px 30px rgba(2,6,23,0.6); border:1px solid rgba(255,255,255,0.03)}

    .lead{font-size:18px; line-height:1.5; color:#dbeef0}
    .kpi{display:flex; gap:12px; margin-top:18px}
    .pill{background:var(--glass); padding:10px 12px; border-radius:10px; font-weight:600; font-size:13px}

    .aside .profile{display:flex; gap:12px; align-items:center}
    .avatar{width:64px;height:64px;border-radius:12px;background:linear-gradient(180deg,#1a2b3d,#0b1b2a);display:flex;align-items:center;justify-content:center;font-weight:700;color:var(--accent)}
    ...
    .service{background:rgba(255,255,255,0.02); padding:12px; border-radius:10px; font-weight:700}

    .about{margin-top:22px; display:flex; gap:18px; align-items:flex-start}
      ...
      <section class="card">
        ...
        <div class="about">
          <div style="flex:1">
            ...
            <h3 style="margin-top:14px;">Approach</h3>
            <div class="two">
      ...
      <aside style="display:flex; flex-direction:column; gap:18px">
        <div class="card">
          ...
          <div style="margin-top:12px">
            <a class="btn btn-cta" href="https://docs.google.com/forms/d/e/1FAIpQLScqToK7krE8E8TR4nL3mGA8T7Pb2tEIJlGVOvBY4xUd_i4iQQ/viewform?usp=header" target="_blank">Claim trial</a>
          </div>
        </div>
